        ...
        public DataTable present()
        {
           ...
           /* str1 = DropDownList1.SelectedItem.Text;
            switch (str1)
            {
                ...
                case "JANUARY":
                    String x = "select name,COUNT(date) from Adata where Adata.date='10-01-2019' ";
                    SqlDataAdapter Adp = new SqlDataAdapter(x, conn);
                    DataTable Dt = new DataTable();
                    Adp.Fill(Dt);
                    GridView1.DataSource = Dt;
                    GridView1.DataBind();
                ...
                case "FEBRUARY":
                    x = "select name,date from Adata where Adata.date='17-01-2019' ";
                    Adp = new SqlDataAdapter(x, conn);
                    Dt = new DataTable();
                    Adp.Fill(Dt);
                    GridView1.DataSource = Dt;
                    GridView1.DataBind();
                ...
                case "MARCH":
                    x = "select name,date from Adata where Adata.date='11-01-2019' ";
                    Adp = new SqlDataAdapter(x, conn);
                    Dt = new DataTable();
                    Adp.Fill(Dt);
                    GridView1.DataSource = Dt;
                ...
                case "APRIL":
                    x = "select name,date from Adata where Adata.date='10-01-2019' ";
                    Adp = new SqlDataAdapter(x, conn);
                    Dt = new DataTable();
                    Adp.Fill(Dt);
                    GridView1.DataSource = Dt;
