<%@ Page Title="" Language="C#" MasterPageFile="~/RFID.Master" AutoEventWireup="true" CodeBehind="login11.aspx.cs" Inherits="RFIDPRJ.login" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    <td colspan="4" bgcolor="#4ABDAC" align="center">
                        <asp:Login ID="Login3" runat="server" BackColor="#F7F7DE" BorderColor="#CCCC99" 
                            BorderStyle="Solid" BorderWidth="1px" DestinationPageUrl="~/categories.aspx" 
